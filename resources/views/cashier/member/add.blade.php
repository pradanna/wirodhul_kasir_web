    ...
    @if (\Illuminate\Support\Facades\Session::has('success'))
        <script>
            Swal.fire({
                ...
                window.location.href = '{{ route('cashier.member') }}';
            })
        </script>
    @endif
    <div class="dashboard">
        <div class="d-flex justify-content-between align-items-center mb-1">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('cashier.member') }}">Member</a></li>
        ...
        <div class="card-content">
            <form method="post" id="form-data">
                ...
                <div class="w-100 mb-3">
                    <label for="phone" class="form-label input-label">No. HP <span
                            class="color-danger">*</span></label>
                    <input type="number" placeholder="No. HP" class="text-input" id="phone"
                           name="phone">
                    @if($errors->has('phone'))
                        <span id="phone-error" class="input-label-error">
                        {{ $errors->first('phone') }}
                    </span>
                    @endif
                </div>
