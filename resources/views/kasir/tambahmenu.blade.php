                    ...
                    <div class="menu overflow-hidden">
                        <form onsubmit="return saveForm()" id="form">
                            ...
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="p-namamenu" name="namamenu"
                                    placeholder="Nama Menu">
                                <label for="p-namamenu" class="form-label">Nama Menu</label>
                            </div>

                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="p-deskripsi" name="deskripsi"
                                    placeholder="Deskripsi Singkat">
                                <label for="p-deskripsi" class="form-label">Deskripsi Singkat</label>
                            </div>

                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="p-harga" name="harga"
                                    placeholder="Harga">
                                <label for="p-harga" class="form-label">Harga</label>
                            </div>
